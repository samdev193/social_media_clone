...
let virtual-env = "C:\Program Files (x86)\PycharmProjects\social_clone"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Program Files (x86)\PycharmProjects\social_clone\Scripts\deactivate.nu"
